...
class TransactionViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        subject =  UIStoryboard(name: "Main", bundle: Bundle(for: HomeViewController.self)).instantiateViewController(withIdentifier: "transactionViewController") as? TransactionViewController
